// Hoopoe-owned tests for the vendored t3code keybindings helpers.
// Implementation files (./parser.ts, ./evaluator.ts, ./types.ts) carry
// MIT notices where lifted; tests are Hoopoe-authored.
