...
// hp-k7as: QualityDimension/QualityReport/QualityDimensionScore/
// QualityEvidence/QualityRequest types and the EvaluatePlanQuality
// scoring surface (qualitySpecs + qualityContext + qualityInput +
// helpers) moved to quality.go (first cut).
...
// hp-k7as: artifact IO helpers (writeTextFile, writeJSONFile,
// readPlanMeta, cloneStringMap, recordsFromMeta, appendHistory,
// digestString) moved to artifacts.go (cut #2).
